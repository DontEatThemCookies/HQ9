...
$ python phoenix.py [filename] [-t] [-h]

To enter REPL mode, simply launch the engine without arguments.
To directly interpret a file, do "python phoenix.py [filename]"
To transcompile a file, do "python phoenix.py [filename] -t"

[filename] The name of the source HQ9+ file to interpret/transcompile.
[-t] If passed, the engine transcompiles the source file to Python 3.
[-h] Displays help.
