...
Needed to prevent NameErrors (prints blank if that certain var wasn't called)'''
h = ""
h1 = ""
q = ""
q1 = ""
...
header = "# HQ9+ compiled into Python 3 - "+str(datetime.datetime.now())
n = " \n" # Newline

acm = 0 # Accumulator
acm2 = "acm = 0 # Accumulator"
...
A = input("Input commands [valid: H, Q, +]: ")
...
try:
        ...
        with open(filename, 'x') as f:
                ...
                '''if '9' in A: # 99 Bottles of Beer - WIP
                        nine = ""+str(beersong())+""'''
                ...
                # To do: add "+n" after "+nine" once beersong func is made
        ...
        e = input("Would you like to remove the file? [Y/N] ")
        if e == "Y":
                os.remove(filename)
                print("File deleted.")
                sleep(2)
