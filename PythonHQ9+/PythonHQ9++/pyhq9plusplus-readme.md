...
Among the variants aforementioned, HQ9++ is one of them. The specification was made by David M. Mar, famous for making esolangs such as Piet and Chef. Primarily it makes HQ9+ object-oriented through the implementation of an additional command "++". [Learn about it here.](https://www.dangermouse.net/esoteric/hq9plusplus.html)
